...
CREATE TABLE IF NOT EXISTS purchase_docs (
  ...
  total_ope_gravadas_local numeric(18,6) default 0,
  total_ope_gravadas_usd numeric(18,6) default 0,
  total_ope_gravadas_clp numeric(18,6) default 0,
  total_ope_exoneradas numeric(18,6) default 0,
  total_ope_exoneradas_local numeric(18,6) default 0,
  total_ope_exoneradas_usd numeric(18,6) default 0,
  total_ope_exoneradas_clp numeric(18,6) default 0,
  total_ope_inafectas numeric(18,6) default 0,
  total_ope_inafectas_local numeric(18,6) default 0,
  total_ope_inafectas_usd numeric(18,6) default 0,
  total_ope_inafectas_clp numeric(18,6) default 0,
  total_igv numeric(18,6) default 0,
  total_igv_local numeric(18,6) default 0,
  total_igv_usd numeric(18,6) default 0,
  total_igv_clp numeric(18,6) default 0,
...
CREATE TABLE IF NOT EXISTS purchase_doc_items (
  ...
  total_line_local numeric(18,6)  null,
  total_line_usd numeric(18,6)  null,
  total_line_clp numeric(18,6)  null,
  created_at timestamptz default now()
);
...
CREATE TABLE IF NOT EXISTS sales_doc_items (
  ...
  unit_price_local numeric(18,6) default 0,
  unit_price_usd numeric(18,6) default 0,
  unit_price_clp numeric(18,6) default 0,
  discount_amount numeric(18,6) default 0,
  discount_pct numeric(18,6) default 0,
  type_price varchar(2) default '01' references sunat.cat_16_tipo_precio_unitario(code),
  igv_affectation varchar(2) default '10' references sunat.cat_07_afect_igv(code),
  igv_amount numeric(18,6) default 0,
  igv_amount_local numeric(18,6) default 0,
  igv_amount_usd numeric(18,6) default 0,
  igv_amount_clp numeric(18,6) default 0,
  isc_amount numeric(18,6) default 0,
  total_line numeric(18,6) not null, -- sin IGV
  total_line_local numeric(18,6) default 0,
  total_line_usd numeric(18,6) default 0,
  total_line_clp numeric(18,6) default 0,
  created_at timestamptz default now()
);
...
CREATE TABLE public.stock_ledger (
    ...
    balance_unit_cost_local monetary,
    balance_unit_cost_usd monetary,
    balance_unit_cost_clp monetary,

    balance_total_cost monetary,
    balance_total_cost_local monetary,
    balance_total_cost_usd monetary,
    balance_total_cost_clp monetary,
...
-- ============================================================================
-- Estructura de ubicaciones agregando:
